...
resource "aws_subnet" "private_app_a" {
  ...
  tags = {
    Name = "${var.environment}-private-app-subnet-a"
  }
}
...
resource "aws_subnet" "private_app_b" {
  ...
  tags = {
    Name = "${var.environment}-private-app-subnet-b"
  }
}
...
resource "aws_subnet" "private_db_a" {
  ...
  tags = {
    Name = "${var.environment}-private-db-subnet-a"
  }
}
resource "aws_subnet" "private_db_b" {
  ...
  tags = {
    Name = "${var.environment}-private-db-subnet-b"
  }
}
